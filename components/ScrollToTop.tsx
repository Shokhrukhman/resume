...
export function ScrollToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-24 right-4 md:bottom-12 md:right-6 z-50 p-3 bg-accent text-black rounded-full shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all duration-300 ease-in-out ${
